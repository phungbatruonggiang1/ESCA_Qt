...
NUM_CHANNELS = 1   
BIT_DEPTH = 16   
# SAMPLE_RATE = config_manager.get("RECORD.SAMPLERATE")
# NUM_CHANNELS = config_manager.get("RECORD.CHANNEL")
# BIT_DEPTH = config_manager.get("RECORD.SAMPLESIZE")
...
# channels = 32  
# f_min = 100  
# frame_rate = config_manager.get("RECORD.SAMPLING_RATE")
...
# model = load_model(config_manager.get("TRANSFER_LEARNING.BASED_WEIGHTS"))
# print(config_manager.get("TRANSFER_LEARNING.BASED_WEIGHTS"))
# print(model.summary())
